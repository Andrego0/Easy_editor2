...
"font-size: 20px;")
        ...
        self.image_list.setGeometry(QtCore.QRect(20, 90, 201, 501))
...
"padding: 10px;")
        ...
        self.right_btn.setGeometry(QtCore.QRect(220, 20, 121, 51))
...
"padding: 10px;")
        ...
        self.left_btn.setGeometry(QtCore.QRect(350, 20, 121, 51))
...
"padding: 10px;")
        ...
        self.blur_btn.setGeometry(QtCore.QRect(480, 20, 111, 51))
...
"padding: 10px;")
        ...
        self.bw_btn.setGeometry(QtCore.QRect(600, 20, 141, 51))
        self.bw_btn.setStyleSheet("border: 3px solid white;\n"
"border-radius: 5px;\n"
"padding: 10px;")
        self.bw_btn.setObjectName("bw_btn")
        self.image_label = QtWidgets.QLabel(self.centralwidget)
        self.image_label.setGeometry(QtCore.QRect(240, 90, 691, 561))
        self.image_label.setObjectName("image_label")
        self.save_btn = QtWidgets.QPushButton(self.centralwidget)
        self.save_btn.setGeometry(QtCore.QRect(50, 600, 141, 51))
...
"padding: 10px;")
        ...
        self.mirror_btn.setGeometry(QtCore.QRect(750, 20, 121, 51))
        self.mirror_btn.setStyleSheet("border: 3px solid white;\n"
"border-radius: 5px;\n"
"padding: 10px;")
        self.mirror_btn.setObjectName("mirror_btn")
        self.pushButton = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton.setGeometry(QtCore.QRect(884, 22, 111, 51))
        self.pushButton.setStyleSheet("border: 3px solid white;\n"
"border-radius: 5px;\n"
"padding: 10px;")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton.setText(_translate("MainWindow", "Різкість"))
